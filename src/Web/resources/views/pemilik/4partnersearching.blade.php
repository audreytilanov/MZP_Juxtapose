    ...
    <div class="container" style="background-color: #F2F2F2; padding:30px;">
        <form style="background-color: #FFFFFF;padding:3vw;border-radius:10px;" method="post" action="{{ route('fase.4.partner.post') }}" enctype="multipart/form-data">
            ...
            <div class="mb-3" style="text-align: left">
                ...
                <textarea name="visi" class="form-control" placeholder="Visi usaha anda..." id="floatingTextarea" required></textarea>
            </div>
            <div class="mb-3" style="text-align: left">
                <label for="misi" class="form-label">Misi Perusahaan</label>
                <textarea name="misi" class="form-control" placeholder="Misi usaha anda..." id="floatingTextarea" required></textarea>
            </div>
            <div class="mb-3" style="text-align: left">
                <label for="budayakerja" class="form-label">Budaya Pekerjaan Karyawan</label>
                <textarea name="budayakerja" class="form-control" placeholder="Budaya Pekerjaan karyawan anda..." id="floatingTextarea" required></textarea>
            </div>
            <div class="mb-3" style="text-align: left">
                <label for="milestone" class="form-label">Milestone Perusahaan 5 Tahun Kedepan</label>
                <textarea name="milestone" class="form-control" placeholder="Milestone 5 Tahun kedepan..." id="floatingTextarea" required></textarea>
            </div>
            <div class="mb-3" style="text-align: left">
                <label for="kebutuhanmitra" class="form-label">Kebutuhan Bidang Kemitraan</label>
                <textarea name="kebutuhanmitra" class="form-control" placeholder="Kebutuhan Mitra untuk..." id="floatingTextarea" required></textarea>
            </div>
            <div class="mb-3" style="text-align: left">
                <label for="tujuanbermitra" class="form-label">Alasan dan Tujuan Bermitra</label>
                <textarea name="tujuanbermitra" class="form-control" placeholder="Tujuan BerMitra untuk..." id="floatingTextarea" required></textarea>
            </div>
            <div class="mb-3" style="text-align: left">
                <label for="kompetensimitra" class="form-label">Kredibilitas dan Kompetensi Mitra</label>
                <textarea name="kompetensimitra" class="form-control" placeholder="Kredibilitas dan Kompetensi Mitra untuk..." id="floatingTextarea" required></textarea>
            </div>
            <div class="mb-3" style="text-align: left">
                <label for="catatan" class="form-label">Catatan Tambahan untuk Mitra (*opsional)</label>
                <textarea name="catatan" class="form-control" placeholder="Catatan untuk mitra..." id="floatingTextarea" required></textarea>
            </div>

            <button style="background-color: transparent;border:2px solid #047857;text-align:center;" class="seeAll btn btn-success" type="submit" class="btn btn-primary">Cari Partner Anda</button>
        </form> 
    </div>
</section>
@endsection