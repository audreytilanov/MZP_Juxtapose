...
<section>
    <div id="periode" class="container">
        <div class="p1">
            <h1 style="color: #979797!important">Pra Penawaran Saham</h1>
        </div>
        <div class="p2">
            <h1><u>Penawaran Saham</u></h1>
        </div>
        <div class="p3">
...
<section class="container" id="infoSaham">
    ...
    <div id="persentaseSaham">
        ...
        <h4>{{ $hasilAkhir }}/<b>100%</b></h4>
    </div>
    @if (Auth::user()->role == 'pemilik')
    <div style="text-align: center;margin-top:20px;">
        <a style="background-color: transparent;border:2px solid #047857;" href="" class="seeAll btn btn-success">Start Penawaran</a>
    </div>
    @elseif(Auth::user()->role == 'investor')
    <div style="text-align: center;margin-top:20px;">
        <a style="background-color: transparent;border:2px solid #047857;" href="{{ route('beli.saham',$usaha->id) }}" class="seeAll btn btn-success">Beli Saham</a>
    </div>
    @endif
